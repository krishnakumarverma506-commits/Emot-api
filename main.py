...
ADMIN_UID = "1735896378"  # Your admin UID
server2 = "BD"
key2 = "MAHFUJ"
...
# Ghost join API
GHOST_API_URL = "https://rizerxghostbd.onrender.com/x/teamcode/MASUM"
# ================================================================
...
def send_likes(uid):
    try:
        likes_api_response = requests.get(
             f"https://mahfuj-like-api.vercel.app/like?uid={uid}&region=BD&key=YASHxPU007",
             timeout=15
             )
...
[FFFFFF]ㅤWhatsApp : [00BFFF]016[b]2569[b]8500 
 
[FFFFFF]ㅤㅤContact for Bot Access
[FFFF00]ㅤ  ㅤㅤOwner : MAHFUJ
...
"""
                        ...
                        if inPuTMsG.startswith('/join'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    if can_send_emote_to(sender_uid) and can_send_emote_to(13777711848):
                        ...
                        if inPuTMsG.startswith('/l'):
                            # Process /l command in any chat type
...
"""
                        ...
                        # EVO CYCLE START COMMAND - /m
                        if inPuTMsG.strip().startswith('/m'):
                            ...
                            # Always use the sender's UID (the person who typed /m)
                            ...
                            if len(parts) > 1:
                                for part in parts[1:]:  # Skip the first part which is "/m"
...
✨ [ffffff] 👤 Developer  :: mahfuj_codex1
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To MAHFUJ  ˣ BOT"
...
[FFFFFF]ㅤTelegram : [00BFFF]mahfuj[b]_offcial[b]_143 
...
async def MaiiiinE():
    Uid, Pw = '4730613258', 'E726017C252BA3E3CFC6E3EF324155DF43E24BDCFECCDA0D2F698032E27BB35F'
    ...
    os.system('clear')
    print("Initializing mahfuj_codex1 Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("🤖 mahfuj_codex1 BOT - ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
